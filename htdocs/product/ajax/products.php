...
if ($action == 'fetch' && !empty($id)) {
	...
	if (empty($mode) || $mode == 1) {  // mode=1: customer
		$maxResults = getDolGlobalInt('MAIN_MAX_PRODUCTS_COMBO_LIST_RESULTS', 50);
		$arrayresult = $form->select_produits_list("", $htmlname, $type, $maxResults, $price_level, $searchkey, $status, $finished, $outjson, $socid, '1', 0, '', $hidepriceinlabel, $warehouseStatus, $status_purchase);
